...
Devin/Yuxi -arduino team, refine movement precision, include start/stop parameters
Travis/Alex - pi team, establish output for arduino movement functions, and refine camera setup

Arduino team status:  DONE
Pi team status:       DONE
